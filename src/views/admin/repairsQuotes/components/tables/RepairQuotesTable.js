...
import RepairQuotesTableDropdowns from '../dropdowns/RepairQuotesTableDropdowns.js';
import { REPAIRS_QUOTES_TABLE_SETTINGS } from '../../../../../settings/TABLES_SETTINGS.js';
import Swal from 'sweetalert2';

export const RepairQuotesTableColumns = [
    {
        Header: "ID",
        accessor: "id",
    },
...
export function RepairQuotesTable(props) {
                            ...
                            <Tr {...row.getRowProps()} key={index}>
                                {row.cells.map((cell, index) => {
                                    ...
                                    if (cell.column.Header === "ID") {
                                        ...
                                        data = (
                                            <Flex fontSize='md' align='center' justifyContent='center' >
                                                <RepairQuotesTableDropdowns recordId={cell.row.values.id} repairId={cell.row.original.repairID} />
                                            </Flex>
                                        );
                                    }
                                    return (
