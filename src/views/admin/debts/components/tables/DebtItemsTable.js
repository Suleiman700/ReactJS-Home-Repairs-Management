...
import DebtItemsTableDropdowns from '../dropdowns/DebtItemsTableDropdowns.js';
import {MdOutlineCheck} from 'react-icons/md';

export const DebtItemsTableColumns = [
    {
        Header: "ID",
        accessor: "id",
    },
...
export function DebtItemsTable(props) {
    // Iterate on items and set each item total price
    const tableDataWithTotalItemsPrices = props.tableData.map(item => ({
        ...item,
        itemTotalPrice: parseFloat(item.itemPrice) * parseFloat(item.itemQuantity)
    }));

    const tableData = tableDataWithTotalItemsPrices
                                ...
                                <Tr background={row.original.isPaid==1?'#00800024':''} {...row.getRowProps()} key={index}>
                                    {row.cells.map((cell, index) => {
                                        ...
                                        if (cell.column.Header === "ID") {
                                            ...
                                            data = (
                                                <Flex align='center' justifyContent='center' >
                                                    <Text color={textColor} fontSize='md' fontWeight='700' align='center' dir='auto' width={85} >
                                                        {cell.value}
                                                    </Text>
                                                </Flex>
                                            );
                                            ...
                                            data = (
                                                <Flex align='center' justifyContent='center' >
                                                    <Text color={textColor} fontSize='md' align='center' dir='auto' width={50} >
                                                        {cell.value}
                                                    </Text>
                                                </Flex>
                                            );
                                            ...
                                            data = (
                                                <Flex align='center' justifyContent='center' >
                                                    <Text color='green' fontSize='md' fontWeight='700' align='center' dir='auto' width={85} >
                                                        {cell.value}
                                                    </Text>
                                                </Flex>
                                            );
                                                                            ...
                                                                            Swal.fire({
                                                                                ...
                                                                                <div >
                                                                                    ...
                                                                                    <div style="margin-top: 5px;">
                                                                                        <span style="text-decoration: underline;">Item Name</span><br>
                                                                                        ${cell.row.original.itemName}
                                                                                    </div>
                                                                                    <div style="margin-top: 5px;">
                                                                                        <span style="text-decoration: underline;">Item Price</span><br>
                                                                                        ${cell.row.original.itemPrice}
                                                                                    </div>
                                                                                    <div style="margin-top: 5px;">
                                                                                        <span style="text-decoration: underline;">Item Quantity</span><br>
                                                                                        ${cell.row.original.itemQuantity}
                                                                                    </div>
                                                                                    <div style="margin-top: 5px;">
                                                                                        <span style="text-decoration: underline;">Item Total Price</span><br>
                                                                                        ${parseFloat(cell.row.original.itemPrice) * parseFloat(cell.row.original.itemQuantity)}
                                                                                    </div>
                                                                ...
                                                                <Flex flexDirection='column' alignItems='center' >
                                                                    ...
                                                                    <Button
                                                                        ...
                                                                        onClick={() => {
                                                                            Swal.fire({
                                                                                icon: 'info',
                                                                                title: `Comment #${cell.row.original.id}`,
                                                                                html: `
                                                                                <div >
                                                                                    <div>
                                                                                        <span style="text-decoration: underline;">Created At</span><br>
                                        ...
                                        else if (cell.column.Header === "TAKEN BY") {
                                            data = (
                                                <Flex align='center' justifyContent='center' >
                                                    <Text color={textColor} fontSize='md' align='center' dir='auto' width={100} >
                                                        {cell.value}
                                            ...
                                            data = (
                                                <Flex align='center' justifyContent='center' >
                                                    <DebtItemsTableDropdowns recordId={cell.row.values.id} />
                                                </Flex>
                                            );
                                        }
                                        return (
